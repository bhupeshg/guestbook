...
<div class="position-relative">
    ...
    echo $this->Form->create('User', array(/*'action' => 'save'*/"url" => array("controller" => "users", "action" => "login"), 'default' => false));
        ...
        <div class="widget-body">
            <div class="widget-main">
                ...
                <fieldset>
                    ...
                    <label class="block clearfix">
                            <span class="block input-icon input-icon-right">
                                <?php echo $this->Form->input("user_pwd", array("class" => "form-control","required" => "required", "placeholder" => "Password","label"=>"Password","type"=>"password"));?>
                                <i class="icon-lock"></i>
                            </span>
                    </label>
