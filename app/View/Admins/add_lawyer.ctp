...
<div class="col-xs-12">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<?php echo $this->Form->input('User.user_pwd', array('label' => false, 'div' => false, 'class' => 'col-xs-10 col-sm-5', 'type' => 'password', 'placeholder' => 'Password', "required" => "required")); ?>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<?php echo $this->Form->input('User.confirm_password', array('label' => false, 'div' => false, 'class' => 'col-xs-10 col-sm-5', 'type' => 'password', 'placeholder' => 'Confirm Password', "required" => "required")); ?>
		</div>
	</div>
