...
echo $this->Form->create('User',array('action' => 'manageClient','id'=>'userListForm','name'=>'userListForm')); ?>
<div class="row-fluid">
    <div class="span12">
        <div class="row-fluid">
            ...
            <tr class="<?php echo ($i%2==1)?'odd':'even';?>"">
                ...
                <td class=" ">
                    <div class="hidden-phone visible-desktop action-buttons">
						...
						<?php echo $this->Html->link('<i class="icon-pencil bigger-130"></i>', array('controller'=>'lawyers','action'=>'editClient',$record['User']['id']), array('escape' => false, 'class' => 'green'))?>
						
						<?php echo $this->Html->link('<i class="icon-trash bigger-130"></i>', array('controller'=>'lawyers','action'=>'deleteClient',$record['User']['id']), array('escape' => false, 'class' => 'red'),"Are you sure you want to delete this client?")?>
