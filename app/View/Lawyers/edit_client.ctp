...
<div class="col-xs-12">
	<!-- PAGE CONTENT BEGINS -->
	<?php echo $this->Form->create('User', array('url' => '/lawyers/editClient/'.$id, 'class' => 'form-horizontal','name'=>'editClient', 'id'=>'editClient')); ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<div class="input-group">
				...
				<?php echo $this->Form->input('Profile.dob', array('label' => false, 'type' => 'text', 'div' => false, 'class' => 'date-picker', 'placeholder' => 'DOB', 'id' => 'id-date-picker-1', 'data-date-format' => 'yyyy-mm-dd', "class" => "form-control date-picker", "required" => "required")); ?>
